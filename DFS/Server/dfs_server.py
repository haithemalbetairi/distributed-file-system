...
class MasterServer(rpyc.Service):
    ...
    class exposed_Master():
        DN_LIST = [["127.0.0.1",8888,Path.home()/'DFS/Dnode1'],       # Define the expected number of Datanodes ...
                   ["127.0.0.1",8000,Path.home()/'DFS/Dnode2']]       # ... that will be used for file storage
        global filemap
