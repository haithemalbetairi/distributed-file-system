...
global IP,PORT,PATH
IP,PORT,PATH = "127.0.0.1",8000,Path.home()/'DFS/Dnode2'
...
if __name__ == "__main__":
    ...
    if(platform.system()=='Windows'):
        ...
        subprocess.call("start cmd /K python ftpserver2.py", shell=True) 

    elif(platform.system()=='Linux'):
        subprocess.Popen(["python3", "ftpserver2.py"], stdout=subprocess.PIPE)
